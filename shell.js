...
(function () {
  ...
  vegasStyle.href = new URL("vegas.css?v=action-20260914", document.currentScript.src).href;
  document.head.appendChild(vegasStyle);
  var vegasScript = document.createElement("script");
  vegasScript.src = new URL("vegas.js?v=action-20260914", document.currentScript.src).href;
