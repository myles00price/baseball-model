...
# 2026-08-12: cap tightened to 6.0 — 7-8% edges graded 42.1% (-$913, n=57).
assert BET_MIN == 3.0 and BET_MAX == 6.0
assert is_bet(+5.2) is True      # Mets morning flag
assert is_bet(+3.0) is True      # window floor inclusive
assert is_bet(+6.0) is True      # window ceiling inclusive
assert is_bet(+6.5) is False     # above the tightened ceiling (was a play pre-2026-08-12)
assert is_bet(+8.0) is False     # old ceiling — no longer a play
